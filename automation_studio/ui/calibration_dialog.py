...
class InteractiveTargetWindow(QWidget):
    """
    A fullscreen click-responsive window displaying a calibration crosshairs at a fixed
...
class CalibrationWizard(QDialog):
    ...
    """
    calibration_complete = Signal(float, float)
    ...
    def init_ui(self):
        ...
        self.desc_lbl = QLabel(
            ...
            "to ensure perfect clicking accuracy regardless of Windows DPI scaling."
        )
    ...
    def record_target_offset(self, corr_x, corr_y):
        ...
        self.desc_lbl.setText(
            ...
            f"Displacement offsets correction applied:<br>"
...
class CalibrationDialog(QDialog):
    ...
    def init_ui(self):
        ...
        layout.addWidget(QLabel("Apply micro pixel adjustments directly on top of your calibrated visual templates."))
