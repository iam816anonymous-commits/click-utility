...
from automation_studio.windows.coordinate_manager import SystemDpiCalibrator, CoordinateCalculationResult, CoordinateValidator
            ...
            try:
                ...
                for rule in active_rules_snapshot:
                    ...
                    if rule.trigger_type == "Image Template Match":
                        template = MatchEngine.load_template(rule.template_path)
                        if template is None:
                            continue
                        ...
                        # OCR text matching fallback to MatchEngine
                        pass
